...
\begin{quadro}[H]
    ...
    \begin{tabularx}{\linewidth}{|p{3cm}|p{2.2cm}|p{2cm}|p{2.2cm}|p{1cm}|p{1.3cm}|p{4cm}|p{3cm}|X|}
        \hline
        \textbf{Nome} & \textbf{Métricas} & \textbf{Benchmark} & \textbf{Warmup}  & \textbf{Exec.} & \textbf{Excl.} & \textbf{Resultado} & \textbf{O que comparou} & \textbf{Teste} \\ \hline
        ...
        \begin{minipage}[t]{\linewidth}
            I/O Test – Duas aplicações Java: uma envia requisições (GET), outra simula operação bloqueante.\\
