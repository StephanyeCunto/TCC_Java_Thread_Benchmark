...
\begin{document}
    ...
    \begin{table}
        ...
        \begin{minipage}[t]{\linewidth}
            ...
            Após o ramp-up, iniciou-se o período de 10 minutos de requisições constantes.\\
            Cada usuário fazia requisições GET para o endpoint bloqueante, mantendo o servidor sob rajadas contínuas.\\
        \end{minipage}
        & 
        \begin{minipage}[t]{\linewidth}
            Foram realizados dois tipos de experimentos:\\
            (1) Aumento gradual de carga (*load ramping*) para detectar o ponto de saturação.\\
            (2) Carga constante para medir estabilidade sob uso intenso.\\
            Cada execução foi repetida 5 vezes, descartando outliers e observando CPU, heap e latência.\\
        \end{minipage} \\ \hline
