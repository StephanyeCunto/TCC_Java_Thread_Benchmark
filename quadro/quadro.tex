...
\begin{document}
    ...
    \begin{landscape}
        \begin{quadro}[H]
            ...
            \begin{tabularx}{\linewidth}{|p{3cm}|p{2cm}|p{2.5cm}|p{2cm}|p{2cm}|p{2.5cm}|p{2cm}|p{3cm}|X|}
                \hline
                \textbf{Nome} & \textbf{Métricas} & \textbf{Benchmark} & \textbf{Warmup} & \textbf{Exclusão} & \textbf{Resultado} & \textbf{Execuções} & \textbf{O que comparou} & \textbf{Tipo de teste} \\ \hline
